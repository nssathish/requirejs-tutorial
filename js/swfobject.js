...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta name="request-id" content="67FCA1F5:346C:184BC8B:57F50902" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="67FCA1F5:346C:184BC8B:57F50902" name="octolytics-dimension-request_id" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="user-login" content="">
      ...
      <meta name="js-proxy-site-detection-payload" content="NDc4NzEwZWRhYzY0NGY2YmQ4NDcwNzlkMTQyZDY5NjYyMjY3MTkyYmQ3OGZmZWE5ZGJiYzY1NzBjMTRjODVjMHx7InJlbW90ZV9hZGRyZXNzIjoiMTAzLjI1Mi4xNjEuMjQ1IiwicmVxdWVzdF9pZCI6IjY3RkNBMUY1OjM0NkM6MTg0QkM4Qjo1N0Y1MDkwMiIsInRpbWVzdGFtcCI6MTQ3NTY3NjQyM30=">
...
<ul class="pagehead-actions">
  ...
  <li>
    ...
    <a href="/swfobject/swfobject/network" class="social-count"
       aria-label="381 users are forked this repository">
      381
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <a href="/swfobject/swfobject/projects" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /swfobject/swfobject/projects">
...
<a href="/swfobject/swfobject/blob/232ce6e024736a3877a61b4343dea0a383bca56d/swfobject/swfobject.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:07919853323d77f8f8f2182079a0309e -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      <span class="right">
        ...
        <relative-time datetime="2013-05-22T04:30:26Z">May 22, 2013</relative-time>
      </span>
      <div>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/swfobject/swfobject/raw/master/swfobject/swfobject.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/swfobject/swfobject/blame/master/swfobject/swfobject.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item">Blame</a>
      <a href="/swfobject/swfobject/commits/master/swfobject/swfobject.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-k">if</span>(ac){<span class="pl-k">if</span>(<span class="pl-sr"><span class="pl-pds">/</span><span class="pl-cce">\?</span><span class="pl-pds">/</span></span>.<span class="pl-c1">test</span>(ac)){ac<span class="pl-k">=</span><span class="pl-smi">ac</span>.<span class="pl-c1">split</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>?<span class="pl-pds">&quot;</span></span>)[<span class="pl-c1">1</span>]}<span class="pl-k">if</span>(ad<span class="pl-k">==</span><span class="pl-c1">null</span>){<span class="pl-k">return</span> <span class="pl-en">N</span>(ac)}<span class="pl-k">var</span> ab<span class="pl-k">=</span><span class="pl-smi">ac</span>.<span class="pl-c1">split</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>&amp;<span class="pl-pds">&quot;</span></span>);<span class="pl-k">for</span>(<span class="pl-k">var</span> aa<span class="pl-k">=</span><span class="pl-c1">0</span>;aa<span class="pl-k">&lt;</span><span class="pl-smi">ab</span>.<span class="pl-c1">length</span>;aa<span class="pl-k">++</span>){<span class="pl-k">if</span>(ab[aa].<span class="pl-c1">substring</span>(<span class="pl-c1">0</span>,ab[aa].<span class="pl-c1">indexOf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>=<span class="pl-pds">&quot;</span></span>))<span class="pl-k">==</span>ad){<span class="pl-k">return</span> <span class="pl-en">N</span>(ab[aa].<span class="pl-c1">substring</span>((ab[aa].<span class="pl-c1">indexOf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>=<span class="pl-pds">&quot;</span></span>)<span class="pl-k">+</span><span class="pl-c1">1</span>)))}}}<span class="pl-k">return</span><span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-pds">&quot;</span></span>},<span class="pl-en">expressInstallCallback</span><span class="pl-k">:</span><span class="pl-k">function</span>(){<span class="pl-k">if</span>(a){<span class="pl-k">var</span> aa<span class="pl-k">=</span><span class="pl-en">c</span>(<span class="pl-c1">S</span>);<span class="pl-k">if</span>(aa<span class="pl-k">&amp;&amp;</span><span class="pl-c1">I</span>){<span class="pl-smi">aa</span>.<span class="pl-c1">parentNode</span>.<span class="pl-c1">replaceChild</span>(<span class="pl-c1">I</span>,aa);<span class="pl-k">if</span>(p){<span class="pl-en">w</span>(p,<span class="pl-c1">true</span>);<span class="pl-k">if</span>(<span class="pl-c1">O</span>.<span class="pl-smi">ie</span>){<span class="pl-c1">I</span>.<span class="pl-c1">style</span>.<span class="pl-c1">display</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&quot;</span>block<span class="pl-pds">&quot;</span></span>}}<span class="pl-k">if</span>(<span class="pl-c1">E</span>){<span class="pl-en">E</span>(<span class="pl-c1">B</span>)}}a<span class="pl-k">=</span><span class="pl-c1">false</span>}},version<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">&quot;</span>2.3<span class="pl-pds">&quot;</span></span>}}();</td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2016 <span title="0.05800s from github-fe152-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
